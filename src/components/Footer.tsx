...
const SocialIcon = ({ children, href, label }: SocialIconProps) => (
  <a
    ...
    aria-label={label} //  FIX: Added aria-label for screen readers
  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="container mx-auto px-6 pt-10 pb-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <SocialIcon href="https://www.facebook.com/keeprollingmedia" label="Follow us on Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </SocialIcon>
              <SocialIcon href="https://www.instagram.com/keeprollingmedia/" label="Follow us on Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/gallery" className="text-gray-600 hover:text-red-600 transition-colors">Gallery</Link></li>
        ...
        <div className="mt-12 py-4 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-gray-500 text-sm">
            Powered by{' '}
            <a 
              href="https://geckoworksnepal.com" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="font-medium hover:text-red-600 transition-colors duration-300"
              // FIX: Changed the color to a darker, accessible green
              style={{ color: '#006400' }}
            >
              Gecko Works Nepal
            </a>
